"""
FTWS: The is the main scripts for training FGAN_uncond.
The difference between this scripts to train_fgan_uncond is it dont use custom parallel.
"""
...
def run(config):
    ...
    loaders = vae_utils.get_minidata_loaders(**{**config, 'batch_size': D_batch_size,
